...
public class DAOHandler {
	...
	private String pass = "";
		...
		public void insert_local_vehicle(String vehicle_type, String number_plate, String insurance_company,
			...
			try{
				...
				//a query for inserting data to the database
				String query5 = "INSERT INTO local_vehicles(vehicle_type, number_plate, insurance_company, premium, vehicle_condition, purchase_date, assigned_driver) VALUES (?,?,?,?,?,?,?)";
				//prepare a statement
				...
				st.setString(5, condition);
				st.setString(6, purchase_date);
				st.setString(7, assigned_driver);
